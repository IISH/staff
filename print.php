...
<ol>
	<li><a href=\"print_firstname.php\" target=\"_blank\">" . Translations::get('lbl_firstname') . "</a></li>
	<li><a href=\"print_lastname.php\" target=\"_blank\">" . Translations::get('lbl_lastname') . "</a><br><br>" . Translations::get('or_go_to') . "<br><br></li>
